module Var = {
  @val @scope(("process", "env")) external apiGraphql: option<string> = "API_GRAPHQL"
}

module Relay = {
  /* @see <https://rescript-relay-documentation.vercel.app/docs/getting-started#setting-up-the-relay-environment> */
  ...
  let fetchQuery: RescriptRelay.Network.fetchFunctionPromise = (
    ...
    open Fetch
    fetchWithInit(
      Var.apiGraphql->Option.getWithDefault("https://graphql-pokemon2.vercel.app/"),
      RequestInit.make(
        ~method_=Post,
      ...
      if Response.ok(resp) {
        ...
        Graphql_error("Request failed: " ++ Response.statusText(resp))->Js.Promise.reject
      }
    , _)
  }
